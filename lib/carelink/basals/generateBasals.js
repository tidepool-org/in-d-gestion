 ...
 * 2. If the current stored event has a duration field, events start showing up with a timestamp that happens
 *    after the given duration has completed.
 *
      ...
      function (outputObservable) {
        ...
        return rx.Observer.create(
          function (e) {
            ...
            if (e.type === 'basal' && e.deliveryType === 'scheduled' && !misc.isAnnotated(e, 'carelink/basal/temp-percent-create-scheduled')) {
