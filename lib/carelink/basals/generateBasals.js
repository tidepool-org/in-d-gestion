        ...
        function doScheduled(e) {
          ...
          for (var j = 0; j < schedule.length; ++j) {
            if (schedule[j].rate === e.value && e.startTime === schedule[j].start) {
              ...
              return outputObservable.onNext(_.omit(currScheduled, 'startTime'));
            }
          }
          currScheduled = null;
          return outputObservable.onNext(misc.annotateEvent(_.omit(e, 'startTime'), 'carelink/basal/off-schedule-rate'));
        }
