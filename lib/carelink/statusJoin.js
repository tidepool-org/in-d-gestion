                      ...
                      outputObs.onNext(
                        {
                          ...
                          duration: moment(e.time).valueOf() - moment(suspendEvent.time).valueOf(),
                          time: suspendEvent.time,
                          deviceTime: suspendEvent.deviceTime,
                          timezoneOffset: suspendEvent.timezoneOffset,
                          deviceId: suspendEvent.deviceId
                        }
                      );
                      outputObs.onNext(suspendEvent);
                      outputObs.onNext(_.assign({}, e, { previous: _.omit(suspendEvent, 'previousStatus') }));
                      suspendEvent = null;
                    } else {
