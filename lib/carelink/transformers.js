...
var generateBasals = require('./basals/generateBasals.js');
var misc = require('../misc.js');
var parsing = require('../parsing.js');
var settingsJoin = require('./settingsJoiner.js');
var statusJoin = require('./statusJoin.js');
var attachPrevBasal = require('./basals/attachPrevBasal.js');
...
function basalSort(e){
  ...
  if (e.type === 'basal' && e.deliveryType === 'temp' && e.duration === 0) {
    return 2;
  }
  return 3;
}
...
module.exports = function (configFn) {
  ...
  var deviceTimeToUtcFn = misc.deviceTimeToUtc(configFn().timezone);
    ...
    return observable
      ...
      .splitMerge(function(e){
                  ...
                  function(key, observable) {
                    var minTimestamp = moment.utc('3000-01-01T00:00:00.000Z');
                    var maxTimestamp = moment.utc('0000-01-01T00:00:00.000Z');
                    var configFnOverride = function() {
                      return _.assign({}, configFn(), {
                        startTime: minTimestamp,
                        endTime: maxTimestamp
                      });
                    };

                    function maintainTimestampBounds(e) {
                      if (e.deviceTime.isBefore(minTimestamp)) {
                        minTimestamp = e.deviceTime.clone();
                      }
                      if (e.deviceTime.isAfter(maxTimestamp)) {
                        maxTimestamp = e.deviceTime.clone();
                      }
                      return e;
                    }
                    ...
                    return observable
                      .keep(eventParser)
                      .map(deviceTimeToUtcFn)
                      .map(maintainTimestampBounds)
                      ...
                      .splitMerge(function(e) {
                                  ...
                                  },
                                  {
                                    ...
                                    settingsAndBasal: function(observable) {
                                      return observable
                                        .sort(misc.buildSortCompareFn(['deviceTime', basalSort]))
                                        .apply(generateBasals(
                                                 {
                                                   'basal': function(stored, e){
                                                     switch(e.deliveryType) {
                                                       ...
                                                       default:
                                                         throw except.ISE(
                                                           'Unknown deliveryType[%s], ts[%s]', e.deliveryType, e.deviceTime
                                                         );
                                                     }
                                                   }
                                                 },
                                  ...
                                  },
                                  {
                                    basaly: function(observable) {
                                      return observable
                                        ...
                                        .apply(generateBasals(
                                                 {
                                                   'deviceMeta': function(stored, e){
                                                     if (e.subType === 'status' && e.status === 'suspended') {
                                                       return e;
                                                     } else {
                                                       return null;
                                                     }
