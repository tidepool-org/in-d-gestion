            ...
            function(e) {
              ...
              if (matchesExpectedNext(e)) {
                ...
                if (currBasalRate === e.value) {
                  ...
                  // It's a basal that doesn't line up with our expected schedule.  Not sure why or when
                  // this happens to just annotate and move on
                  outputObservable.onNext(misc.annotateEvent(e, 'basal/off-schedule-rate'));
                }
              }
            },
