...
module.exports = function(observable) {
  return observable
      ...
      function(outputObservable){
        ...
        function computeMillisInCurrentDay(dateTime) {
        ...
        function setExpectedNext() {
          ...
          if (expectedNext == null) {
            ...
            if (currSchedule.length < 1) {
              ...
              var currentDayMillis = computeMillisInCurrentDay(currSettings.deviceTime);
            ...
            function(e) {
              ...
              if (matchesExpectedNext(e)) {
                ...
                if (currBasalRate === e.value) {
                  ...
                  var startMillis = computeMillisInCurrentDay(e.deviceTime);
