      ...
      function(outputObservable){
        function emitTempIfExists(currTime) {
          if (tempBasal != null) {
            ...
            if (theTemp.duration > fiveDays) {
              theTemp.duration = fiveDays;
              misc.annotateEvent(theTemp, 'diasend/basal/temp-duration-truncated');
            }
        ...
        return rx.Observer.create(
          function(e) {
            ...
            tempBasal = misc.annotateEvent(
              ...
              'diasend/basal/temp-basal-fabrication'
            );
          },
