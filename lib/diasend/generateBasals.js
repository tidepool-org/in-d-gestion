        ...
        function emitTempIfExists(currTime) {
          if (tempBasal != null) {
            ...
            if (dur === 0) {
              ...
              // two readings for when a basal rate should change according to schedule.  One for the scheduled
              // rate and one for what was actually delivered.  This is actually preferrable as an event
              // emission system is concerned, but it fools the logic here into believing that the temp was
              // really short and didn't actually happen.  Thus, if we get a temp that is a duration of 0,
              // Then we assume that it is a case like this and the event we are comparing against to compute our
              // duration is incorrect.  Don't emit the temp and move on.
              return false;
            }
