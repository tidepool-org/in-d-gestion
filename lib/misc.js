...
exports.addDeviceTimeFn = function(fieldName, dateFormat){
  return function(e) {
    if (e.deviceTime == null) {
      ...
      e.deviceTime = moment.utc(e.deviceTime, 'YYYY-MM-DDTHH:mm:ss');
    }
    return e;
  };
};
...
exports.deviceTimeToUtc = function(timezone) {
  return function(e) {
    ...
    e.ts = walltime.WallTimeToUTC(timezone, moment.utc(deviceTime, 'YYYY-MM-DDTHH:mm:ss').toDate()).toISOString();
    e.timezoneOffset = (moment.utc(deviceTime).valueOf() - moment.utc(e.ts).valueOf()) / 60000;
    return e;
  };
};
